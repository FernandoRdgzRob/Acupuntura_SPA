...
<header class="container d-flex justify-content-between mt-4">
    ...
    <section class="container mt-5">
        ...
        <?php try {
            ...
            $nombre = htmlspecialchars($_POST['n_principio']);
            $uso = htmlspecialchars($_POST['u_principio']);
            $sql = "INSERT INTO info_principio_activo(nombre_sustancia, uso_principio) VALUES('$nombre', '$uso')";
            $resultado = $conn->query($sql); ?>

            <div class="pt-4 pl-5">
                <h1>Se agregó exitosamente el siguiente principio activo:</h1>
                <h2 class="mt-5 pl-5">Nombre: <?php echo $nombre; ?></h2>
                <h2 class="mt-5 pl-5">Uso: <?php echo $uso; ?></h2>     
            </div>       
        <?php }
