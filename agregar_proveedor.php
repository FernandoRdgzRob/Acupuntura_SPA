...
<body>
    ...
    <section class="container mt-5">
        ...
        <?php try {
            ...
            $nombre = htmlspecialchars($_POST['n_proveedor']);
            $direccion = htmlspecialchars($_POST['dir_proveedor']);
            $sql = "INSERT INTO info_proveedor(nombre_proveedor, direccion_proveedor) VALUES('$nombre', '$direccion')";
            $resultado = $conn->query($sql); ?>

            <div class="pt-4 pl-5">
                <h1>Se agregó exitosamente el siguiente proveedor:</h1>
                <h2 class="mt-5 pl-5">Nombre: <?php echo $nombre; ?></h2>
                <h2 class="mt-5 pl-5">Dirección: <?php echo $direccion; ?></h2>
            </div>    
